...
public class CategoryController {
    ...
    public ResponseEntity<Category> getCategoryById(@PathVariable(name = "id") Long id) throws EntityNotFoundException {
        if (log.isDebugEnabled()) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> updateCategory(@PathVariable(name = "id") Long id, @RequestBody CategoryDto updatedFields) {
        if (log.isDebugEnabled()) {
