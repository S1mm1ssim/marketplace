...
public class UserController {
    ...
    public UserResponse getUserById(@PathVariable(name = ID_PATH_VARIABLE_NAME) UUID id) {
    ...
    @PostMapping
    public String createUser(@Valid @RequestBody UserRequest userDto) {
    ...
    public void updateUser(@PathVariable(name = ID_PATH_VARIABLE_NAME) UUID id,
                           @Valid @RequestBody UserRequest updatedFields) {
